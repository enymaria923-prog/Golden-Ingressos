...
Eu confirmo que a tabela é `'eventos'` e a coluna é `'imagem_url'` neste código.

Por favor, use este código para o `app/publicar-evento/page.js`. Se o problema persistir, o próximo passo é verificar a configuração das regras de acesso (RLS) no seu Supabase Storage e na sua tabela `eventos`.
